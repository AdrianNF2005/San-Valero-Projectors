...
Una vez estemos dentro de la carpeta o directorio en el que queramos modificar los archivos, nos aparecerá un listado de todas las imagenes o videos disponibles en ese apartado. Seleccionaremos la imagen o video que queramos cambiar el orden.

![2p](https://github.com/user-attachments/assets/009c1f87-dc13-40d0-a6fd-0513cc6aa6bf)

A continuación haremos click en el simbolo del lapicero para editar el número del archivo como se muestra a continuación:
...
Cuando terminemos de cambiar el número para que se guarden los cambiós, haremos click en **"Commit changes"**

![4p](https://github.com/user-attachments/assets/62333494-9f68-4915-84df-21fa361c6083)

 y finalmente en el ménu que nos aparece le volveremos a dar en el botón verde que pone **"Commit changes"**

![5p](https://github.com/user-attachments/assets/02ac8009-9303-4aa8-808c-fb45c479f039)


## ¿Como elimino las imagenes o videos que ya no quiero?
...
Una vez estemos dentro de la carpeta o directorio en el que queramos eliminar los archivos, nos aparecerá un listado de todas las imagenes o videos disponibles en ese apartado. Seleccionaremos la imagen o video que queramos eliminar.
...
y por ultimo al igual que en otros pasos para que se nos apliquen los cambios, deberemos hacer click en el botón de **"Commit changes"**
